...
-- CreateIndex
CREATE INDEX "CareInstruction_patientId_idx" ON "CareInstruction"("patientId");

-- CreateIndex
CREATE INDEX "CareInstruction_appointmentId_idx" ON "CareInstruction"("appointmentId");
...
-- AddForeignKey
ALTER TABLE "CareInstruction" ADD CONSTRAINT "CareInstruction_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CareInstruction" ADD CONSTRAINT "CareInstruction_appointmentId_fkey" FOREIGN KEY ("appointmentId") REFERENCES "Appointment"("id") ON DELETE SET NULL ON UPDATE CASCADE;
